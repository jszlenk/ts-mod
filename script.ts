{
  ...
  const generateTitleLinks = (customSelector: string = ''): void => {
    ...
    const articles = document.querySelectorAll<HTMLElement>(selectorArticle + customSelector);
    for (let article of articles) {
      ...
      const articleTitleElement = article.querySelector(selectorTitle) as HTMLElement;
      const articleTitle = articleTitleElement.innerHTML as string;
    ...
    const links = document.querySelectorAll<HTMLLinkElement>('.titles a');
  ...
  const generateTags = (): void => {
    ...
    const articles = document.querySelectorAll<HTMLElement>(selectorArticle);
    for (let article of articles) {
  ...
  const generateAuthors = (): void => {
    ...
    /* loop through unique authors and generate author links in sidebar*/
